...
public class InboxActivity extends AppCompatActivity implements CallBackInterface, MessageAdapter.ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new ConnectionDetector(this).isConnectingToInternet()) {
            ...
            background_network.execute(EndPoints.RETRIEVE_INMESSAGE + "?user_id=" + userid);
        } else {
                                        ...
                                        if (etfeedback.getText().toString() != null || etfeedback.getText().toString() != "") {
                                            ...
                                            StringRequest strReq = new StringRequest(Request.Method.POST,
                                                ...
                                                public void onResponse(String response) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (obj.getInt("success") == 1) {
                                                            ...
                                                            Toast.makeText(InboxActivity.this, "successfully sent message", Toast.LENGTH_SHORT).show();
                                                ...
                                                protected Map<String, String> getParams() {
                                                    ...
                                                    String userid = PrefUtils.getValue(InboxActivity.this, "app_pref", "userid");


                                                    params.put("userid", userid);
                                                    params.put("category", inboxmessagelist.get(index).getCategory());
                                                    params.put("userto", inboxmessagelist.get(index).getFrom());
